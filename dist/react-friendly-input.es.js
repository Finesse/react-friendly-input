   ...
   */
    ...
    */
			...
			value: function render() {
				return createElement(Input, _extends({}, this.props, {
					value: undefined,
    ...
    */
	...
	function refForwarder(props, ref) {
		return createElement(FriendlyInput, _extends({}, props, {
			forwardedRef: ref
		}));
	}
 ...
 * @type {Function}
 */
export var Input = friendlyInput('input');
 ...
 * @type {Function}
 */
export var TextArea = friendlyInput('textarea');
 ...
 * @type {Function}
 */
export var Select = friendlyInput('select');